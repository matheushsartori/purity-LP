...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-white shadow-sm border-b border-gray-100">
        <div className="container mx-auto px-4 py-6 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <div className="w-12 h-12 rounded-lg bg-[#244545] flex items-center justify-center">
              <Stethoscope className="h-6 w-6 text-white" />
            </div>
            <div>
              <span className="text-2xl font-bold text-[#244545]">Clínica Purity</span>
              <p className="text-sm text-gray-600 font-medium">Nutrição Integrada</p>
            </div>
          </div>
          <Button className="bg-[#244545] hover:bg-[#244545]/90 text-white px-6 py-3">
      ...
      {/* 1ª Seção - Hero */}
      <section className="bg-[#f4f2ea] py-24">
        <div className="container mx-auto px-4 text-center">
          <Badge className="mb-8 bg-white text-[#244545] hover:bg-white/90 border border-[#244545]/20 px-4 py-2">
          ...
          <p className="text-xl text-gray-700 mb-12 max-w-5xl mx-auto leading-relaxed font-light">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Button size="lg" className="bg-[#244545] hover:bg-[#244545]/90 text-white text-lg px-10 py-4 h-auto">
            ...
            <Button
              size="lg"
              variant="outline"
              className="text-lg px-10 py-4 h-auto border-[#244545] text-[#244545] hover:bg-[#244545]/5 bg-transparent"
            >
      ...
      <section className="py-20 bg-[#f4f2ea]">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Você fará uma consulta com nosso time de especialistas que vão mostrar o resultado e um plano
              personalizado para você conseguir se livrar dos sintomas não diagnosticados que você sofre há anos.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-5xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <ul className="space-y-4">
                    <li className="flex items-start space-x-3">
                      ...
                      <span className="text-[#244545]">Lista de TODOS os parasitas identificados</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <CheckCircle className="h-5 w-5 text-[#527769] mt-0.5 flex-shrink-0" />
                      <span className="text-[#244545]">Mapeamento das toxinas ambientais</span>
                    </li>
                  </ul>
                  <ul className="space-y-4">
                    <li className="flex items-start space-x-3">
                      <CheckCircle className="h-5 w-5 text-[#527769] mt-0.5 flex-shrink-0" />
                      <span className="text-[#244545]">Alimentos incompatíveis específicos</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <CheckCircle className="h-5 w-5 text-[#527769] mt-0.5 flex-shrink-0" />
            ...
            <div className="text-center">
              <Button size="lg" className="bg-[#244545] hover:bg-[#244545]/90 text-white text-xl px-12 py-6 h-auto">
                FAZER MEU TESTE AGORA
                <ArrowRight className="ml-4 h-6 w-6" />
              </Button>
              <p className="text-sm text-gray-500 mt-4 font-medium">Resultado garantido em até 7 dias úteis</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Footer */}
      <footer className="bg-[#244545] text-white py-16">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-12">
            <div>
              <div className="flex items-center space-x-4 mb-8">
                <div className="w-12 h-12 rounded-lg bg-[#d9b975] flex items-center justify-center">
                  <Stethoscope className="h-6 w-6 text-[#244545]" />
                </div>
                <div>
                  <span className="text-2xl font-bold">Clínica Purity</span>
                  <p className="text-sm text-gray-300 font-medium">Nutrição Integrada</p>
                </div>
              </div>
            </div>

            <div>
              <h3 className="text-xl font-semibold mb-6 text-[#d9b975]">DÚVIDAS? FALE CONOSCO:</h3>
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <Phone className="h-5 w-5 text-[#d9b975]" />
                  <span>WhatsApp: (41) 99999-9999</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Mail className="h-5 w-5 text-[#d9b975]" />
                  <span>Email: contato@clinicapurity.com.br</span>
                </div>
              </div>
            </div>

            <div>
              <h3 className="text-xl font-semibold mb-6 text-[#d9b975]">CLÍNICA PURITY</h3>
              <div className="space-y-3 text-gray-300">
                <div className="flex items-start space-x-3">
                  <MapPin className="h-5 w-5 text-[#d9b975] mt-0.5" />
                  <div>
                    <p>Rua das Flores, 123 - Batel, Curitiba/PR</p>
          ...
          <div className="text-center">
            <div className="mb-6">
              <p className="font-semibold text-[#d9b975] text-lg">Dra. Elisangela de Andrade</p>
              <p className="text-gray-300 italic">Nutricionista CRN 1234</p>
              <p className="text-[#d9b975] font-medium italic">16 anos transformando vidas</p>
            </div>
            <p className="text-sm text-gray-400">
              © {new Date().getFullYear()} Clínica Purity. Todos os direitos reservados.
            </p>
          </div>
        </div>
      </footer>
      ...
      <div className="fixed bottom-8 right-8 z-50">
        <Button size="lg" className="bg-green-600 hover:bg-green-700 rounded-full shadow-xl animate-pulse w-16 h-16">
